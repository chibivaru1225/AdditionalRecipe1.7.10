	...
	public void init() {
		...
		if (ARGetCrafting("AlchemicItem", true)) {
			if (ARGetCrafting("ExchangeIgnition", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "ExchangeIgnition" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
					ARLogger.logger.info("ExchangeIgnition" + RecipeHandler.RECIPE + RecipeHandler.NOTADDED);
					// System.out.println(AdditionalRecipe.CONSOLE + "ExchangeIgnition" +
					// RecipeHandler.RECIPE + RecipeHandler.NOTADDED);
				}
			}
			if (ARGetCrafting("DustExchangeIgnition", true)) {
				GameRegistry.addSmelting(ARGetItemRegister("exchangeiginiton"),
						new ItemStack(ARGetItemRegister("dustexchangeignition"), 1, 0), 0.0f);
				if (ARGetAnother("ConsoleOut", true)) {
					ARLogger.logger.info("DustExchangeIgnition" + RecipeHandler.RECIPE + RecipeHandler.ADDED);
					// System.out.println(AdditionalRecipe.CONSOLE + "DustExchangeIgnition" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetCrafting("UltimateExchangeIgnition", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "UltimateExchangeIgnition" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetCrafting("CheaperExchangeIgnition", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "CheaperExchangeIgnition" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetCrafting("CirceForce", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "CirceForce" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "AlchemicItems" +
				// RecipeHandler.RECIPE + RecipeHandler.NOTADDED);
			}
		}
		if (ARGetCrafting("BlackRottenFlesh", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "BlackRottenFlesh" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("Mortar", true)) {
			if (ARGetCrafting("BedrockMortar", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "BedrockMortar" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetCrafting("DiamondMortar", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "DiamondMortar" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetCrafting("IronMortar", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "IronMortar" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "Mortars" +
				// RecipeHandler.RECIPE + RecipeHandler.NOTADDED);
			}
		}
		if (ARGetCrafting("GravitationFeather", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "GravitationFeather" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("NightVisionTorch", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "NightVisionTorch" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("SuperGravitationFeather", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "SuperGravitationFeather" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("BedrockArmor", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "BedrockArmor" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("AngelusArmor", true)) {
			...
			if (ARGetAnother("ConsoleOut", true)) {
				...
				// System.out.println(AdditionalRecipe.CONSOLE + "AngelusArmor" +
				// RecipeHandler.RECIPE + RecipeHandler.ADDED);
			}
		} else {
			if (ARGetAnother("ConsoleOut", true)) {
		...
		if (ARGetCrafting("Weapons", true)) {
			if (ARGetCrafting("Exelector", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "Exelector" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
					// System.out.println(AdditionalRecipe.CONSOLE + "ForceBall" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			 ...
			 * //System.out.println(AdditionalRecipe.CONSOLE + "NIOH" + RecipeHandler.RECIPE
			 * + RecipeHandler.ADDED);
			 * }
			 * }
			 * else
			 ...
			 * if(ARGetAnother("ConsoleOut",true))
			 * {
			 * //System.out.println(AdditionalRecipe.CONSOLE + "Evil Spear 'DAYO'" +
			 * RecipeHandler.RECIPE + RecipeHandler.ADDED);
			 * }
			 * }
			 * else
			 ...
			 * if(ARGetAnother("ConsoleOut",true))
			 * {
			 * //System.out.println(AdditionalRecipe.CONSOLE + "Villany Sword 'YORU'" +
			 * RecipeHandler.RECIPE + RecipeHandler.ADDED);
			 * }
			 * }
			 * else
		...
		if (ARGetCrafting("K2 Items", true)) {
			if (ARGetCrafting("Multi-Tool K2", true)) {
				...
				if (ARGetAnother("ConsoleOut", true)) {
					...
					// System.out.println(AdditionalRecipe.CONSOLE + "K2's Multi-Weapon" +
					// RecipeHandler.RECIPE + RecipeHandler.ADDED);
				}
			} else {
				if (ARGetAnother("ConsoleOut", true)) {
			...
			if ((Loader.isModLoaded("ShionOnlyWins") || Loader.isModLoaded("shiononlywins"))
					&& ARGetCrafting("ShionArmor", true)) {
				GameRegistry.addRecipe(
						new ShapelessOreRecipe(
			...
			if (ARGetCrafting("Charm Of Guardian", true)) {
				GameRegistry.addRecipe(
						new ShapelessOreRecipe(
								...
								new Object[] { ARGetItemRegister("k2helmet"), ARGetItemRegister("k2plate"),
										ARGetItemRegister("k2legs"), ARGetItemRegister("k2boots") }));
				if (ARGetAnother("ConsoleOut", true)) {
			...
			GameRegistry.addRecipe(
					new ShapelessOreRecipe(
							new ItemStack(ARGetItemRegister("dustbread"), 1),
							new Object[] { "dustWheat", }));
			GameRegistry.addRecipe(
					new ShapelessOreRecipe(
							new ItemStack(ARGetItemRegister("dustbread"), 2),
							new Object[] { "dustWheat", "dustWheat", }));
			GameRegistry.addRecipe(
					new ShapelessOreRecipe(
							new ItemStack(ARGetItemRegister("dustbread"), 3),
							new Object[] { "dustWheat", "dustWheat", "dustWheat", }));
			GameRegistry.addRecipe(
					new ShapelessOreRecipe(
							new ItemStack(ARGetItemRegister("dustbread"), 4),
							new Object[] { "dustWheat", "dustWheat", "dustWheat", "dustWheat", }));
		}
	}
}
