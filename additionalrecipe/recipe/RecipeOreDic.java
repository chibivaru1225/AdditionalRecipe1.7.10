...
public class RecipeOreDic {
	public void init() {
		...
		// GameRegistry.addRecipe(
		// new ShapelessOreRecipe(
		// new ItemStack(OreDictionary.getOres("shardPrismarine").get(0).getItem(), 2,
		// OreDictionary.getOres("shardPrismarine").get(0).getItemDamage()),
		// new Object[]{Items.quartz, Items.quartz}));
		// ARLogger.logger.info("shardPrismarine" + RecipeHandler.RECIPE +
		// RecipeHandler.ADDED);
		// }
		// else
		// {
		...
		// GameRegistry.addRecipe(
		// new ShapelessOreRecipe(
		// new ItemStack(OreDictionary.getOres("crystalPrismarine").get(0).getItem(), 2,
		// OreDictionary.getOres("crystalPrismarine").get(0).getItemDamage()),
		// new Object[]{Items.quartz, Items.coal}));
		// ARLogger.logger.info("crystalPrismarine" + RecipeHandler.RECIPE +
		// RecipeHandler.ADDED);
		// }
		// else
		// {
