...
public class RecipeSmelting {
	public void init() {
		...
		if (ARGetSmelting("Paper", true)) {
			for (ItemStack wood : OreDictionary.getOres("pulpWood")) {
				GameRegistry.addSmelting(wood, new ItemStack(Items.paper), 0.0f);
			}
			for (ItemStack wood : OreDictionary.getOres("dustWood")) {
				GameRegistry.addSmelting(wood, new ItemStack(Items.paper), 0.0f);
			}
		}
		if (ARGetSmelting("Bread", true)) {
			GameRegistry.addSmelting(Items.wheat, new ItemStack(Items.bread), 0.01f);
			GameRegistry.addSmelting(ARGetItemRegister("dustbread"), new ItemStack(Items.bread), 0.01f);
		}
		 ...
		 * }
		 * if((OreDictionary.getOres("dustCopper").size() > 0) &&
		 * (OreDictionary.getOres("ingotCopper").size() > 0))
		 * {
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new ItemStack(OreDictionary.getOres("ingotCopper").get(0).getItem(),1,
		 * OreDictionary.getOres("ingotCopper").get(0).getItemDamage()),
		 * new Object[]{"dustCopper",ARGetItemRegister("craftingfurnace")}));
		 * }
		 * if((OreDictionary.getOres("dustTin").size() > 0) &&
		 * (OreDictionary.getOres("ingotTin").size() > 0))
		 * {
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new
		 * ItemStack(OreDictionary.getOres("ingotTin").get(0).getItem(),1,OreDictionary.
		 * getOres("ingotTin").get(0).getItemDamage()),
		 * new Object[]{"dustTin",ARGetItemRegister("craftingfurnace")}));
		 * }
		 * if((OreDictionary.getOres("dustSilver").size() > 0) &&
		 * (OreDictionary.getOres("ingotSilver").size() > 0))
		 * {
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new ItemStack(OreDictionary.getOres("ingotSilver").get(0).getItem(),1,
		 * OreDictionary.getOres("ingotSilver").get(0).getItemDamage()),
		 * new Object[]{"dustSilver",ARGetItemRegister("craftingfurnace")}));
		 * }
		 * if((OreDictionary.getOres("dustLead").size() > 0) &&
		 * (OreDictionary.getOres("ingotLead").size() > 0))
		 * {
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new
		 * ItemStack(OreDictionary.getOres("ingotLead").get(0).getItem(),1,OreDictionary
		 * .getOres("ingotLead").get(0).getItemDamage()),
		 ...
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new ItemStack(OreDictionary.getOres("ingotNickel").get(0).getItem(),1,
		 * OreDictionary.getOres("ingotNickel").get(0).getItemDamage()),
		 * new Object[]{"dustNickel",ARGetItemRegister("craftingfurnace")}));
		 * }
		 * if((OreDictionary.getOres("dustPlatinum").size() > 0) &&
		 * (OreDictionary.getOres("ingotPlatinum").size() > 0))
		 * {
		 * GameRegistry.addRecipe(
		 * new ShapelessOreRecipe(
		 * new ItemStack(OreDictionary.getOres("ingotPlatinum").get(0).getItem(),1,
		 * OreDictionary.getOres("ingotPlatinum").get(0).getItemDamage()),
