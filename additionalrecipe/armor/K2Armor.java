...
public class K2Armor extends InsaneArmorBase
{
    public K2Armor(ArmorMaterial par1EnumArmorMaterial, int par2, int par3, String par4type)
    {
        super(par1EnumArmorMaterial, par2, par3, par4type, ADRArmorTypes.K2);
    }
